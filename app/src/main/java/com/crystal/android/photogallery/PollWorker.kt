...
class PollWorker(val context: Context, workParams: WorkerParameters) : Worker(context, workParams) {
    ...
    companion object {
        const val ACTION_SHOW_NOTIFICATION = "com.crystal.android.photogallery.SHOW_NOTIFICATION"
        const val PERM_PRIVATE = "com.crystal.android.photogallery.PRIVATE"
